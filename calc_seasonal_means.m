function [ser_time_mean_first,ser_time_mean_last,ser_time_mean_middle,data_mean]= calc_seasonal_means(ser_time,data,season,data_treshold,missing_option)
...
data_seasonal_mean=ones(length(yrs),size(data_monthly_mean,2))*NaN;
...
for i=1:length(yrs)
  ...
  if start_indx<end_indx
    ...
    data_seasonal_mean(i,:)=mean(data_monthly_mean(start_indx2:end_indx2,:));
  else
...
data_mean=data_seasonal_mean;

disp(['calc_seasonal_means: Finished'])
